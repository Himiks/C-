...
public:
	...
	Food(deque<Vector2> snakeBody) {
		Image image = LoadImage("grafics/red.png");
...
public:
	...
	Game() {
		...
		wallSound = LoadSound("sounds/audio1.mp3");
	}
...
int main() {
	...
	while (WindowShouldClose() == false) {
		...
		DrawText(TextFormat("The best score : %i", curscore), offset - 50, offset + cellSize * cellCount + 40, 30, darkGreen);
		game.Draw();
		EndDrawing();
